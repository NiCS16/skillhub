                ...
                <form action="{{ route('pendaftaran.update', $pendaftaran->id) }}" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select @error('peserta_id') is-invalid @enderror" 
                            ...
                            <option value="{{ $peserta->id }}" {{ old('peserta_id', $pendaftaran->peserta_id) == $peserta->id ? 'selected' : '' }}>
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select @error('kelas_id') is-invalid @enderror" 
                            ...
                            <option value="{{ $kela->id }}" {{ old('kelas_id', $pendaftaran->kelas_id) == $kela->id ? 'selected' : '' }}>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="date" class="form-control @error('tanggal_daftar') is-invalid @enderror" 
                               ...
                               value="{{ old('tanggal_daftar', $pendaftaran->tanggal_daftar) }}" required>
